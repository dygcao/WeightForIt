...
<div class="row programfeed">
    ...
    <% foreach (var item in ViewData["programfeed"] as List<WeightForIt.Models.Program>) { %>  
        <tr>
            <td><strong><%: Html.ActionLink(item.label, "UserProfile", "/", new { id = item.ProgramId }, null) %></strong> [<%: Html.ActionLink(item.UserProfile.UserName, "User", "/", new { id = item.UserProfile.UserId }, null) %>]</td>
